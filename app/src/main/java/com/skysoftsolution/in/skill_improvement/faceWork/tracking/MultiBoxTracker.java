package com.skysoftsolution.in.skill_improvement.faceWork.tracking;
...
public class MultiBoxTracker {
    ...
    private static final int[] COLORS = {Color.BLUE, Color.RED, Color.GREEN, Color.YELLOW, Color.CYAN, Color.MAGENTA, Color.WHITE,
    ...
    public synchronized void draw(final Canvas canvas) {
        ...
        for (final TrackedRecognition recognition : trackedObjects) {
            ...
            @SuppressLint("DefaultLocale") final String strConfidence = recognition.detectionConfidence < 0 ? "" : String.format("%.2f", (recognition.detectionConfidence)) + "";

            final String labelString = !TextUtils.isEmpty(recognition.title) ? String.format("%s %s", recognition.title, strConfidence) : strConfidence;
