...
import com.skysoftsolution.in.skill_improvement.faceWork.CameraConnectionFragment;
import com.skysoftsolution.in.skill_improvement.faceWork.LegacyCameraConnectionFragment;
import com.skysoftsolution.in.skill_improvement.faceWork.env.ImageUtils;
import com.skysoftsolution.in.skill_improvement.faceWork.env.Logger;

import java.nio.ByteBuffer;

public abstract class ViCameraActivity extends AppCompatActivity implements OnImageAvailableListener, Camera.PreviewCallback, CompoundButton.OnCheckedChangeListener, View.OnClickListener {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tfe_od_activity_camera_for_video);
        if (hasPermission()) {
            setFragment();
        } else {
            requestPermission();
    ...
    private void requestPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (shouldShowRequestPermissionRationale(PERMISSION_CAMERA)) {
                Toast.makeText(ViCameraActivity.this, "Camera permission is required for this demo", Toast.LENGTH_LONG).show();
            }
    ...
    protected void setFragment() {
        ...
        if (true) {
                    ...
                    CameraConnectionFragment.newInstance(
                            new CameraConnectionFragment.ConnectionCallback() {
                                ...
                                public void onPreviewSizeChosen(final Size size, final int rotation) {
                                    ...
                                    ViCameraActivity.this.onPreviewSizeChosen(size, rotation);
                                }
                            },
                            this,
                            getLayoutId(),
            ...
            camera2Fragment.setCamera(String.valueOf(Camera.CameraInfo.CAMERA_FACING_FRONT));
            fragment = camera2Fragment;

        } else {
            int facing = (useFacing == CameraCharacteristics.LENS_FACING_BACK) ?
                    Camera.CameraInfo.CAMERA_FACING_BACK : Camera.CameraInfo.CAMERA_FACING_FRONT;
            LegacyCameraConnectionFragment frag = new LegacyCameraConnectionFragment(this, getLayoutId(), getDesiredPreviewFrameSize(), facing);
            fragment = frag;
        }
